    ...
    <main class="container">
      ...
      @endif
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <input type="text" id="search" class="form-control" placeholder="Buscar Reportes" />
              ...
              <div class="modal-content">
                <form action="{{ route('reportes.update', $reporte->id) }}" method="POST">
                  ...
                  <div class="modal-body">
                    <div class="mb-3">
                      <label for="editId{{ $reporte->id }}">ID</label>
                      <input type="number" name="id" id="editId{{ $reporte->id }}" class="form-control" value="{{ $reporte->id }}" required>
                    </div>
                    <div class="mb-3">
                      <label>Título</label>
                      <input type="text" name="tituloReporte" class="form-control" value="{{ $reporte->tituloReporte }}" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="date" name="fechaEmision" class="form-control" value="{{ $reporte->fechaEmision }}" required>
                    </div>
                  </div>
      ...
      <div class="modal-content">
        <form action="{{ route('reportes.store') }}" method="POST">
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
              <label>Título</label>
              <input type="text" name="tituloReporte" class="form-control" required>
            </div>
            <div class="mb-3">
              <label>Descripción</label>
