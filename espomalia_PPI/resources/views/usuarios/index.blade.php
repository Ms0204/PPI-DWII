                ...
                <tbody>
                    @forelse ($usuarios as $index => $usuario)
                        <tr>
                            ...
                            <td>{{ str_repeat('•', strlen($usuario->contrasenia)) }}</td>
            ...
            <form action="{{ route('usuarios.store') }}" method="POST" class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" name="contrasenia" id="addContrasenia" class="form-control" required />
                        <button type="button" class="btn btn-outline-secondary" onclick="togglePassword('addContrasenia', this)">
            ...
            <form id="editUserForm" method="POST" class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" name="contrasenia" id="editContrasenia" class="form-control" required />
                        <button type="button" class="btn btn-outline-secondary" onclick="togglePassword('editContrasenia', this)">
                            <i class="fas fa-eye"></i>
                        </button>
                    </div>
                    <div class="mb-3">
