...
<body>
  ...
  <main class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
      <input type="text" id="search" class="form-control" placeholder="Buscar Ingresos" aria-label="Buscar Ingresos">
      <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addUserModal">
        <i class="fas fa-user-plus"></i> Agregar Ingreso
      </button>
    </div>  
    <!-- Tabla de ingreso -->
    <table class="table table-bordered table-striped">
        ...
        <nav>
          ...
          <div class="modal-header">
            <h5 class="modal-title" id="addUserModalLabel">Agregar Ingreso</h5>
          ...
          <div class="modal-body">
            <form id="addUserForm">
              ...
              <div class="mb-3">
                <label for="addFechaIngreso" class="form-label">Fecha Ingreso</label>
                <input type="date" class="form-control" id="addFechaIngreso" required>
              </div>
              <div class="mb-3">
...
<div class="modal fade" id="editUserModal" tabindex="-1" aria-labelledby="editUserModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="editUserModalLabel">Editar Ingreso</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
