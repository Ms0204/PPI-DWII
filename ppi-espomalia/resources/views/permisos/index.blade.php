...
<body>
  ...
  <main class="container">
    <!-- Barra de búsqueda y agregar roles -->
    <div class="d-flex justify-content-between align-items-center mb-4">
      <input type="text" id="search" class="form-control" placeholder="Buscar Permisos" aria-label="Buscar Permisos">
      <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addUserModal">
        <i class="fas fa-user-plus"></i> Agregar Permisos
      </button>
    </div>  
    <!-- Tabla de roles -->
    <table class="table table-bordered table-striped">
        ...
        <div class="modal-header">
          <h5 class="modal-title" id="addUserModalLabel">Agregar Permisos</h5>
        ...
        <div class="modal-body">
          <form id="addUserForm">
            ...
            <div class="mb-3">
                <label for="addNombre" class="form-label">Fecha Asignacion</label>
                <input type="date" class="form-control" id="addNombre" required>
              </div>
            <div class="mb-3">
              <label for="addDescripcion" class="form-label">Estado</label>
              <input type="text" class="form-control" id="addDescripcion" required>
            </div>
            <div class="mb-3">
                <label for="addCedulaUsuairo" class="form-label">Cedula Usuario</label>
                <input type="text" class="form-control" id="addCedulaUsuario" required>
              </div>            
              <div class="mb-3">
                <label for="addIdRol" class="form-label">Id Rol</label>
                <input type="text" class="form-control" id="addIdRol" required>
              </div>
    ...
    <!-- Modal Editar rol -->
        ...
        <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="editUserModalLabel">Editar Permisos</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
        ...
        <div class="mb-3">
            <label for="editNombre" class="form-label">Fecha Asignacion</label>
            <input type="date" class="form-control" id="editNombre" required>
        </div>
        <div class="mb-3">
            <label for="editDescripcion" class="form-label">Estado</label>
            <input type="text" class="form-control" id="editDescripsion" required>
        </div>
        <div class="mb-3">
            <label for="editCedulaUsuairo" class="form-label">Cedula Usuario</label>
            <input type="text" class="form-control" id="editCedulaUsuario" required>
          </div>            
          <div class="mb-3">
            <label for="editIdRol" class="form-label">Id Rol</label>
            <input type="text" class="form-control" id="editIdRol" required>
          </div>
